...
const boxes_repo_prisma_1 = require("./boxes.repo.prisma");
...
exports.BoxesModule = BoxesModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [
            ...
            boxes_gateway_1.BoxesGateway,
            {
                provide: 'BoxesRepository',
                useClass: boxes_repo_prisma_1.BoxesRepoPrisma,
            },
        ],
        exports: [boxes_service_1.BoxesService, 'BoxesRepository'],
    })
], BoxesModule);
